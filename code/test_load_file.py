...
from summerizing import summerizer 
import nltk

file=loader.XMLFile("../data/C90-2039_TRAIN/Citance_XML/C92-1059.xml")
#summerizer.TextSummerizer.summerizeXml("../data/C90-2039_TRAIN/Citance_XML/C92-1059.xml")
print file
